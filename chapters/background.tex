...
Not only that, but, for different vendors, the values of the SMART attributes are not guaranteed to be compatible \cite{SamsungSSD}, meaning that the same attribute ID may denote different metrics.
